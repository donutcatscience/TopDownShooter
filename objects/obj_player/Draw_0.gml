...
if (currentHealth < maxHealth) {
	draw_healthbar(x-16,y-60,x+16,y-54, (currentHealth/maxHealth)*100,c_black,c_red,c_green,0,true,true);
}
if(gamepad_is_connected(0)){
	//handle melee animation
	if fireWeapon = 1 {
			image_speed = 1;
			draw_sprite_ext(playerCurrentFeet, walkFrame, x,y,sizeModifier,sizeModifier,(point_direction(0,0, inputHoriz, inputVert)),c_white,1);
			draw_sprite_ext(playerCurrentTorso, torsoFrame, x,y,sizeModifier,sizeModifier,(point_direction(0,0, inputHoriz, inputVert)),c_white,1);
			++torsoFrame;
			--currentTempTorso;
